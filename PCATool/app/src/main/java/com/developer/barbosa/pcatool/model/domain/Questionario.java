...
@XStreamAlias("questionario")
public class Questionario implements Serializable {

    @XStreamAlias("idQuestionario")
    private long id_questionario;

    @XStreamAlias("dataRealizacao")
    private String dataRealizacao;

    @XStreamAlias("tipoQuestionario")
    private String tipoQuestionario;

    @XStreamAlias("escoreEssencial")
    private double escoreEssencial;

    @XStreamAlias("escoreGeral")
