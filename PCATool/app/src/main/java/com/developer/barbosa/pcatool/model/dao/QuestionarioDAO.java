...
public class QuestionarioDAO extends BDOpenHelper {
    ...
    public long insertQuestionario(Questionario questionario){
        ...
        values.put(BDOpenHelper.ID_REGIONAL, questionario.getRegional().getId_regional());
        values.put(BDOpenHelper.DATA_REALIZACAO, questionario.getDataRealizacao());
        values.put(BDOpenHelper.TIPO_QUESTIONARIO, questionario.getTipoQuestionario());
        values.put(BDOpenHelper.ESCORE_ESSENCIAL, questionario.getEscoreEssencial());
        values.put(BDOpenHelper.ESCORE_GERAL, questionario.getEscoreGeral());
