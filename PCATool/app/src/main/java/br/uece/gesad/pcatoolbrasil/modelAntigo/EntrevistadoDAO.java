...
public class EntrevistadoDAO extends BDOpenHelper {
    ...
    public long insertEntrevistado(Entrevistado entrevistado){
        ...
        values.put(NOME_ENTREVISTADO, entrevistado.getNome());
        values.put(SEXO_ENTREVISTADO, entrevistado.getSexo());
        values.put(DATA_NASCIMENTO, entrevistado.getDataNascimento());

        long id = db.insert(TABELA_ENTREVISTADO, null, values);
        db.close();
